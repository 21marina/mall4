...
class pageOrder(base):
    ...
    def page_proAddr(self):
        ...
        #
    def page_projifen(self,loc=pomall4.loc_jifendisc_select,num=0):
        #勾选使用积分 有的商品有  有的没有
        if self.base_eleIsExit(pomall4.loc_jifendisc_select):
            self.base_find_element(pomall4.loc_jifendisc_select).click()
...
#组装
    def zuzhuangOrder(self,loc,num):
        ...
        self.page_proOrder(pomall4.loc_submit_btn)
